...
const Organizers = ({ event }) => {
  return (
    <div className="bg-secondary py-8 px-6 md:px-12 xl:px-16 w-full
     flex flex-col gap-8 rounded-2xl">
      ...
      {event.organizers.map((organizer, index) => {
        return (
          <div className="flex items-center gap-8 border-b last-of-type:border-none
          border-white/10 pb-8" key={index}>
