...
const Hero = () => {
  ...
  return (
    <section className="h-screen xl:h-[800px] mb-16 relative">
      ...
      >
        <div
          className="w-full max-w-[684px] text-center mx-auto flex flex-col
        gap-2"
        >
        ...
        <div className="">
          ...
          <div className="w-full mt-3 relative flex flex-col justify-center">
            <p
              className="text-sm italic font-light text-white/70 text-center mb-3
            xl:mb-0"
            >
              Please select a field or leave them empty to see all events.
            </p>
            {/* clear search */}
            <button
      ...
      bg-[image:var(--background-hero_1)] bg-blend-color-dodge bg-no-repeat bg-cover -z-10 opacity-50"
      ></div>
      {/* bg 2*/}
      <div
        className="absolute bg-primary top-0 right-0 w-[50vw] h-full
     bg-[image:var(--background-hero_2)] bg-blend-lighten bg-no-repeat bg-cover -z-10 opacity-50"
      ></div>
    </section>
  );
};
